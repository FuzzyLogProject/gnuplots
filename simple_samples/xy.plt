...
plot "throughput/mcs_out.txt" using 1:2 title "MCS " with linespoints ps 4 lt 4 lc rgb "#00FF9C" linewidth 10, \
 "throughput/latchfree_out.txt" using 1:2 title "Latch-free " with linespoints ps 4 lt 3 lc rgb "#FF345C" linewidth 10, \
 "throughput/spinlock_out.txt" using 1:2 title "Spinlock " with linespoints ps 4 lt 8 lc rgb "#F8CA0E" linewidth 10
